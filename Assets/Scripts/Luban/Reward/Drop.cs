...
public sealed partial class Drop : Luban.BeanBase
{
    ...
    {
        { if(!_buf["rewardType"].IsNumber) { throw new SerializationException(); }  RewardType = (Drop.RewardType)_buf["rewardType"].AsInt; }
    ...
    /// 掉落类型
    /// </summary>
    public readonly Drop.RewardType RewardType;
    /// <summary>
    /// 概率，万分比
    /// </summary>
